...
\begin{itemize}
	...
	\item $\mat{X}$ and $\theta$ are independent
	\item $f$ is conditionally dependent on both $\mat{X}$ and $\theta$
	\item $\mat{Y}$ is conditionally dependent on $f$ and conditionally independent of $\mat{X}$ and $\theta$
\end{itemize}
\question [TODO]
