...
\subsubsection{Linear regression}
\question [WRITE ABOUT Q12]
\begin{figure}[H]
	\centering
	\begin{subfigure}[t]{0.4\linewidth}
		\includegraphics[width=\linewidth]{1-posterior}
		\caption{Posterior after 1 observation}
		\label{fig:1-p}
	\end{subfigure}
	\begin{subfigure}[t]{0.4\linewidth}
		\includegraphics[width=\linewidth]{1-samples}
		\caption{Samples of $y$ from posterior after 1 observation}
		\label{fig:1-s}
	\end{subfigure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.4\linewidth}
		...
		\caption{Posterior after 2 observations}
		\label{fig:2-p}
	\end{subfigure}
	\begin{subfigure}[t]{0.4\linewidth}
		\includegraphics[width=\linewidth]{2-samples}
		\caption{Samples of $y$ from posterior after 2 observations}
		\label{fig:2-s}
	\end{subfigure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.4\linewidth}
		...
		\caption{Posterior after 15 observations}
		\label{fig:15-p}
	\end{subfigure}
	\begin{subfigure}[t]{0.4\linewidth}
		\includegraphics[width=\linewidth]{15-samples}
		\caption{Samples of $y$ from posterior after 15 observations}
		\label{fig:15-s}
	\end{subfigure}
	\caption{Linear regression - 15 observations}
\end{figure} \\
\subsubsection{Non-parametric regression}
\question [WRITE ABOUT Q13]
\begin{figure}[H]
	\centering
