...
\begin{align*}
	...
	&\hspace{2em}\times\exp\Big(-\frac{1}{2\tau^2}(\mat{W}-\mat{W}_0)^T\mat{I}(\mat{W}-\mat{W}_0)\Big) \\
	&\propto \exp\Big(-\frac{1}{2\sigma^2}(\mat{Y}-\mat{X}\mat{W})^T\mat{I}(\mat{Y}-\mat{X}\mat{W})-\frac{1}{2\tau^2}(\mat{W}-\mat{W}_0)^T\mat{I}(\mat{W}-\mat{W}_0)\Big) \\
	&\propto \exp\Big(-\frac{1}{2\sigma^2}(\mat{Y}^T\mat{Y}-2\mat{W}^T\mat{X}^T\mat{Y}+\mat{W}^T\mat{X}^T\mat{X}\mat{W}) \\
