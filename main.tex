...
$M_2$ is the next most complex model and will assign more probability mass to all data sets that aren't very unequal or whose decision boundary separating $y = 1$ and $y = -1$ is offset from the origin as both these cases would be better modeled with the bias parameter in $M_3$.
